  ...
  struct
    ...
    module Rubric =
      struct
        ...
        let scores = fun {g1=g1;g2=g2;g3=g3;g4=g4;g5=g5} -> [
        ...
        let fractions =
          let (w1,w2,w3,w4,w5) = weights in
          let weights = List.map Q.of_int [w1;w2;w3;w4;w5] in
        ...
        let toString ({g1;g2;g3;g4;g5} as rubric) =
          let descriptions = [
